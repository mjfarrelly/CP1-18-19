...
public class MM{
    public static void main(String[] args){
		JFrame frame= new JFrame("MM"); // Creates the title of the frame, also createes the object of the frame
        ...
        MMShapes r = new MMShapes(); // creates rhe shape object named r
